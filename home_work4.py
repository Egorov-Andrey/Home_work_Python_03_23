...
# some_list1 = [int(input()) for _ in range(n)]
# some_set1_= set(some_list1)

# m = int(input('Введите количество элементов 2: '))

# some_list2 = [int(input()) for _ in range(m)]
# some_set2_= set(some_list2)

# print((sorted(some_set1_.intersection(some_set2_))))
